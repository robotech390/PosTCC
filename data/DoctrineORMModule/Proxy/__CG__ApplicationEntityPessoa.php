 ...
 */
class Pessoa extends \Application\Entity\Pessoa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Pessoa' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Pessoa' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Pessoa' . "\0" . 'cpf', '' . "\0" . 'Application\\Entity\\Pessoa' . "\0" . 'nascimento', '' . "\0" . 'Application\\Entity\\Pessoa' . "\0" . 'rg', '' . "\0" . 'Application\\Entity\\Pessoa' . "\0" . 'telefone', '' . "\0" . 'Application\\Entity\\Pessoa' . "\0" . 'foto'];
        }
    ...
    public function setNascimento(\DateTime $nascimento): void
    {
        ...
        parent::setNascimento($nascimento);
    }
